...
import braceletDedmoroz from '../../assets/images/things/bracelets/bracelet-dedmoroz.png';
...
const bracelets = [
    ...
    },
    {
        ...braceletVeteranInit,
        id: 5,
        name: `Браслет Дедмороза`,
        icon: braceletDedmoroz,
        iconSorcerer: braceletDedmoroz,
    },
];
